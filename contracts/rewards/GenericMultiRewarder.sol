...
contract GenericMultiRewarder is ReentrancyGuard, Ownable {
    ...
    mapping(address rewardToken => Reward rewardInfo) public rewardData;

    // user -> reward token -> amount
    mapping(address user => mapping(address rewardToken => uint256 amount)) public userRewardPerTokenPaid;
    mapping(address user => mapping(address rewardToken => uint256 amount)) public rewards;
    ...
    function getReward() public nonReentrant updateReward(msg.sender) {
        for (uint i; i < rewardTokens.length; i++) {
            ...
            if (reward > 0) {
                ...
                SafeERC20.safeTransfer(IERC20(_rewardsToken), msg.sender, reward);
    ...
    function notifyRewardAmount(address _rewardsToken, uint256 reward) external updateReward(address(0)) {
        ...
        SafeERC20.safeTransferFrom(IERC20(_rewardsToken), msg.sender, address(this), reward);
